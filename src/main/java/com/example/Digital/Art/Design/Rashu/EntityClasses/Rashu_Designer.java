...
@Entity
@Table(name = "designer") // Replace "your_table_name" with the actual table name
public class Rashu_Designer {
    @Id
    @Column(name = "designer_id") // Map to "Designer_id" column in the database
    private Long id;
